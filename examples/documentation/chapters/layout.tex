...
entries. In the following \cref{tocentries}, each item corresponds to 
...
glossaries and notations in \cref{references}, we will briefly see how
to configure them.
...
option names specified in \cref{papersizes}.
