...
\vcref{doesnot}). This means that this class will only provide 
...
\begin{description}
	...
	name.\sidenote{This is another departure from Tufte's 
	design.}
	...
	margins.\sidenote{Sidenotes (like this!) are numbered while 
	marginnotes are not}
...
\begin{description}
    ...
    margins are defined.\sidenote{See \cref{references}.} It is the 
